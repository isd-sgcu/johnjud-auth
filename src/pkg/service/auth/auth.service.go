...
func NewService(userRepo user.Repository, tokenService token.Service, bcryptUtil utils.IBcryptUtil, cacheRepo cache.Repository) authProto.AuthServiceServer {
	return auth.NewService(userRepo, tokenService, bcryptUtil, cacheRepo)
}
